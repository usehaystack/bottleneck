  ...
  class Bottleneck {
    ...
    submit(...args) {
      ...
      if (typeof args[0] === "function") {
        ...
        ref = args, (_ref = ref, _ref2 = _toArray(_ref), fn = _ref2[0], args = _ref2.slice(1)), (_splice$call = splice.call(args, -1), _splice$call2 = _slicedToArray(_splice$call, 1), cb = _splice$call2[0]);
        options = parser.load({}, this.jobDefaults);
      } else {
        var _ref3, _ref4, _splice$call3, _splice$call4;
        ref1 = args, (_ref3 = ref1, _ref4 = _toArray(_ref3), options = _ref4[0], fn = _ref4[1], args = _ref4.slice(2)), (_splice$call3 = splice.call(args, -1), _splice$call4 = _slicedToArray(_splice$call3, 1), cb = _splice$call4[0]);
